...
\
\
-<del>Full code on GitHub.</del> **code logic available <a src="https://github.com/Gabriele-Donato/website-materials-/tree/BayesianTimeSeries"> here</a>, soon the application and even more materials (read comments on functions)**
\
\
