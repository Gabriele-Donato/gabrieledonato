...
\
\
-A new article with applied project using PySpark and Hadoop. **essential code logic available upon request, soon on GitHub! Project: a sytem to continuously collect and clean data from the "Institute for the Study of War", to be analysed in a future article**
